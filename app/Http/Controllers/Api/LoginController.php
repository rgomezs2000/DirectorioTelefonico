...
class LoginController extends Controller
{
    ...
    public function registrarSesion(int $id_usuario, Request $request): JsonResponse
    {
        try {
            $validacionToken = Helper::validarTokenHeader();
            ...
            $sesion = (object) ((array) $request->input('session', []));
            $idSesion = Sesion::registrarSesion($id_usuario, $sesion);
