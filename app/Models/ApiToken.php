...
class ApiToken extends BaseModel
{
    ...
    /** Crea y retorna un token nuevo sin usar */
    public static function obtenerToken(int $minutosVigencia = 15): self
    {
        $inicio = now();
        ...
        return self::create([
            ...
            'fecha_fin_token'   => $inicio->copy()->addMinutes($minutosVigencia),
            'usado'             => false,
        ]);
    }
